...
def main(cfg: DictConfig):
    ...
    OmegaConf.update(cfg, "pl_module.model.pred_len", cfg.datamodule.dataset.pred_len)
    OmegaConf.update(cfg, "pl_module.model.label_len", cfg.datamodule.dataset.label_len)
    OmegaConf.update(cfg, "pl_module.model.past_len", cfg.datamodule.dataset.past_len)
